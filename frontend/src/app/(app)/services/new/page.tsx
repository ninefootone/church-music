      ...
      <div className="card">
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-md)' }}>
          <div>
            ...
            <input className="input" type="date" required value={form.service_date} onChange={e => setForm(f => ({ ...f, service_date: e.target.value }))} style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box' }} />
          </div>
          <div>
